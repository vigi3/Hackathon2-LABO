...
class CategoryServiceController extends AbstractController
{
    ...
    {
        return $this->render('category_service/index.html.twig', ['category_services' => $categoryServiceRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('category_service/new.html.twig', [
    ...
    {
        return $this->render('category_service/show.html.twig', ['category_service' => $categoryService]);
    }
    ...
    public function edit(Request $request, CategoryService $categoryService): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('category_service_index', ['id' => $categoryService->getId()]);
        }
